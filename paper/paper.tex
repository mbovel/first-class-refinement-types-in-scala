...
\begin{itemize}
  \item \textbf{Mechanization.} The Rocq formalization of the language, type system, semantics, and soundness proof.
  \item \textbf{Implementation.} The source of our Dotty extension, also published on Maven and usable from any SBT project with \lstinline!scalaOrganization := "<redacted for anonymity>"! and \lstinline!scalaVersion := "3.10.0-RC1-bin-20260720-5f1bae1-NIGHTLY"!.
