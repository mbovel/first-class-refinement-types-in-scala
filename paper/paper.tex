...
\begin{itemize}
  \item We present the \textbf{design} of first-class refinement types Scala~3: their syntax, semantics, and interaction with Scala's existing type system, including subtyping, type inference, bounded polymorphism, overloading, and implicits (\S\ref{sec:design}).
