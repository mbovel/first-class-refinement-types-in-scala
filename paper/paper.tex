...
\begin{itemize}
  ...
  \item \textbf{Implementation.} The source of our Dotty extension, also published on Maven and usable from any SBT project with `scalaOrganization := "<redacted for anonymity>"' and `scalaVersion := "3.10.0-RC1-bin-20260720-5f1bae1-NIGHTLY"'.
