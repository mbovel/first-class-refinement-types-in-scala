...
\begin{lstlisting}[morekeywords={Fixpoint,match,with,end,Some,None,option,nat,list},deletekeywords={val},morecomment={[s]{(*}{*)}},commentstyle=\color{gray}\itshape,basicstyle=\ttfamily\codesize]
Fixpoint eval (fuel: nat) (env: list Value) (t: Term)
    : option (option Value) :=
  match fuel with
  | 0 => None (* timeout *)
  | S fuel' =>
